...
import { Send, Search, ShieldCheck, MoreVertical, Paperclip, User, Lock, Loader2, ShieldAlert } from 'lucide-react';
      ...
      <section className="flex-1 flex overflow-hidden">
          ...
          <div className="p-8 pb-4">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-slate-900/50 border border-white/5 rounded-xl py-3 pl-10 pr-4 text-[10px] font-black outline-none focus:border-blue-500/30 transition-all"
              />
            </div>
          </div>
            ...
            {filteredContacts.map((chat) => (
              <button 
                ...
                className={`w-full flex items-center gap-4 p-4 rounded-3xl transition-all border ${
                  activeChat?.employeeId === chat.employeeId ? 'bg-blue-600/10 border-blue-600/20 shadow-lg shadow-blue-500/5' : 'hover:bg-white/5 border-transparent'
                }`}
              >
        ...
        <div className="flex-1 flex flex-col bg-[#020617]">
          {activeChat && currentUser ? (
            <>
              <div className="px-10 py-6 border-b border-white/5 flex justify-between items-center bg-[#020617]/80 backdrop-blur-md sticky top-0 z-10">
                <div className="flex items-center gap-5">
                  <div className="w-11 h-11 rounded-2xl flex items-center justify-center bg-blue-600 overflow-hidden flex-shrink-0">
                    {activeChat.profileImage ? (
                      <img src={activeChat.profileImage} className="w-full h-full object-cover" alt="" />
                    ) : (
                      <span className="font-black text-slate-950">{activeChat.name[0]}</span>
                    )}
                  </div>
                  <div>
                  ...
                  .map((msg, i) => {
                    ...
                    return (
                      <div key={i} className={`flex flex-col ${isMe ? 'items-end ml-auto' : 'items-start'} max-w-[70%]`}>
                        ...
                        {isMe && (
                          <span className="text-[8px] font-black text-slate-600 mt-2 tracking-widest uppercase">
              ...
              <div className="p-10 pt-0">
                <input 
                  ...
                  accept="image/*"
                />
                <div className="bg-slate-900/50 border border-white/10 rounded-[2.5rem] p-2 flex items-center gap-2 focus-within:border-blue-500/50 transition-all shadow-inner backdrop-blur-xl">
                  <button 
                  ...
                  <input 
                    ...
                    placeholder={isUploading ? "UPLOADING MEDIA..." : "TYPE SECURE COMMAND..."} 
                  ...
                  <button 
                    ...
                    className="bg-blue-600 p-4 rounded-full text-white hover:bg-blue-500 transition-all active:scale-95 disabled:opacity-50 shadow-xl shadow-blue-500/20"
                  >
            ...
            <div className="flex-1 flex flex-col items-center justify-center opacity-20 uppercase tracking-[0.8em]">
              <ShieldAlert className="w-16 h-16 mb-4 text-blue-500" />
